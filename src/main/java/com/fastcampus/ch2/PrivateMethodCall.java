...
//		hello.main(); // 에러. private이라서 외부 호출 불가
					  // The method main(String[]) in the type Hello is not applicable for the arguments ()
		// ReflectionAPI를 이용 - 클래스 정보를 얻고 다룰 수 있는 강력한 기능 제공
